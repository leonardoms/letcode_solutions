...
- **Easy**
  - [Two Sum (1)](https://leetcode.com/problems/two-sum) - 💡 [Solução](solutions/1 - arrays/0001_Two-Sum_Easy.cpp)
  - [Remove Duplicates from Sorted Array (26)](https://leetcode.com/problems/remove-duplicates-from-sorted-array) - 💡 [Solução](solutions/1 - arrays/0026_Remove-Dup-Sorted-Arr_Easy.cpp)
- **Medium**
